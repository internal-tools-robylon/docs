...
description: Learn how to configure your Knowledge Base agent with custom instructions, tools, variables, and AI settings to deliver accurate and personalized answers.
sidebarTitle: KB Agent
icon: book-open
---

# Guide: How to Configure the Knowledge Base (KB) Agent
