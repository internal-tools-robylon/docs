...
description: Control which human users have access to the Robylon platform, assign roles, and manage permissions.
sidebarTitle: Human Users
icon: users
---

# Guide: Manage Human Users

The **Human Users tab** is where you manage the people who can access the Robylon platform.  
