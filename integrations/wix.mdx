---
title: "Robylon × Wix Integration: Add Chat to your site"
description: "Install the Robylon chat widget on Wix. Add chat widgets, secure webhooks, and event tracking-without code."
sidebarTitle: "Wix"
...
2. In the left panel, click on the settings button to navigate to the settings page.
   ...
   <Frame>
     ![Robylon dashboard showing the settings menu for chatbot integration in Wix](/Robylon1.png)
   </Frame>
3. Within the settings tab, select [<u>Channels</u>](https://app.robylon.ai/settings/channels).

   <Frame>
     ![Robylon Channels screen with Chatbot channel ready for integration](/Robylon2.png)
   </Frame>
4. Click on the [<u>Chatbot</u>](https://app.robylon.ai/settings/channels/chatbot/interface) widget to access the chatbot details.

   <Frame>
     ![Robylon dashboard with Chatbot option highlighted under “Recommended” channels for proactive support and guided help](/Robylon3.png)
   </Frame>
5. Navigate to the [<u>Install</u>](https://app.robylon.ai/settings/channels/chatbot/install) tab within the chatbot details page.

   <Frame>
     ![Robylon Chatbot details and the Install tab for embed configuration](/Robylon4.png)
   </Frame>
6. Select React to embed code in Wix.

   <Frame>
     ![Robylon dashboard Chatbot Details, Install tab with React option selected, and live chatbot preview of user interaction](/Robylon5React.png)
   </Frame>
7. Copy the provided chatbot embed code.

   <Frame>
     ![Copy the embed code snippet for Robylon chatbot to paste into the Wix site](/images/Robylon6React.png)
   </Frame>
...
### **Step 2**: Sign in to Your Wix Account and Embed Your Chatbot
 ...
 2. On your dashboard, locate and click on the ‘Design Site’ button in the top right corner of the dashboard.
    ...
    <Frame>
      ![Wix Editor site dashboard selecting page to insert Robylon chatbot](/images/Wix1.png)
    </Frame>
 ...
 5. Click on the Big Plus icon (Add Elements) on the left sidebar of your Wix editor.
    ...
    <Frame>
      ![Wix Editor with ‘Add → Embed Code’ (HTML iframe) option in site menu](/images/Wix2.png)
    </Frame>
 6. Scroll down to locate and click on the ‘Embed Code’ button, then click on the ‘Marketing Tools’ button and select ‘Custom Code’ in that section.
    ...
    <Frame>
      ![Wix HTML iframe settings with Robylon embed code pasted](/images/Wix3.png)
    </Frame>
 7. The custom code widget should pop up, click ‘+ Add Custom Code’ in the top right corner of that widget.

    <Frame>
      ![Wix site publish dialog showing the domain and publish button after integration](/images/Wix4.png)
    </Frame>
