...
An **Intent** represents the purpose of a user’s message — e.g., _check order status_, _request refund_, _update email_. Intents help classify and route conversations.
